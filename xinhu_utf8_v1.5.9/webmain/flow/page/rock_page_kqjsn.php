...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"设备号",dataIndex:"num"},{text:"IP地址",dataIndex:"ipAddr"},{text:"用途",dataIndex:"purpose"},{text:"设备名称",dataIndex:"name"},{text:"公司名",dataIndex:"company"},{text:"状态",dataIndex:"status",sortable:true},{text:"排序号",dataIndex:"sort",sortable:true},{text:"最后请求时间",dataIndex:"lastdt",sortable:true},{text:"ID",dataIndex:"id",sortable:true},{text:"sd卡剩余空间",dataIndex:"space",sortable:true},{text:"剩余内存",dataIndex:"memory",sortable:true},{text:"人员数",dataIndex:"usershu"},{text:"指纹数",dataIndex:"fingerprintshu",sortable:true},{text:"头像数量",dataIndex:"headpicshu",sortable:true},{text:"打卡数",dataIndex:"clockinshu",sortable:true},{text:"现场照片数",dataIndex:"picshu",sortable:true},{
